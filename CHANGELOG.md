...
- Replace provider filesystem watch APIs with inert handles on every platform. Providers receive document updates explicitly, and no watch call reaches Node.js filesystem permissions, avoiding platform-specific polling failures without broadening read roots.
