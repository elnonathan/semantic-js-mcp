...
export const RELEASE_CHECK = Object.freeze({
  ...
  VUE_SMOKE: "vue-smoke",
  ROOTS_SMOKE: "roots-smoke",
  PROVIDER_GUARD_SMOKE: "provider-guard-smoke",
...
export const RELEASE_LOCAL_CHECKS = Object.freeze([
  ...
  Object.freeze({name: RELEASE_CHECK.ROOTS_SMOKE, npmScript: "smoke:roots"}),
  Object.freeze({name: RELEASE_CHECK.PROVIDER_GUARD_SMOKE, npmScript: "smoke:provider-guard"}),
